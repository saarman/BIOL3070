---
title: "Wk3 - Uniting WNV & Bloodmeal Datasets"
...
But... we can't without more Cx. tarsalis bloodmeal data, because...
Every bloodmeal observation in overlap is being “tagged” with the
species from the pools at that site × month.
...
host_taxonomy <- data.frame(
  host_species = c(
    "host_Haemorhous_mexicanus",
    "host_House_sparrow",
    "host_Turdus_migratorius",
    "host_Zenaida_macroura",
    "host_Streptopelia_decaocto",
    "host_Sturnus_vulgaris",
    "host_Accipiter_cooperii",
    "host_Cariama_cristata",
    "host_Pica_hudsonia",
    "host_Poecile_atricapillus",
    "host_Homo_sapiens",
    "host_Melospiza_melodia",
    "host_Gallus_gallus",
    "host_Bos_taurus",
    "host_Callipepla_californica",
    "host_Icterus_bullockii",
    "host_Phoenicopterus_chilensis",
    "host_Tyrannus_verticalis",
    "host_Podiceps_nigricollis",
    "host_Petrochelidon_pyrrhonota",
    "host_Canis_familiaris",
    "host_Dromaius_novaehollandiae",
    "host_Coturnix_coturnix",
    "host_Coturnix_japonica",
    "host_Empidonax_sp",
    "host_Catharus_guttatus",
    "host_Cistothorus_palustris",
    "host_Antilocapra_americana",
    "host_Columba_livia",
    "host_Grus_canadensis",
    "host_Buteo_swainsoni",
    "host_Ramphastos_toco",
    "host_Sturnella_neglecta",
    "host_Piranga_ludoviciana",
    "host_Setophaga_petechia"
  ),
  common_name = c(
    "House Finch","House Sparrow","American Robin","Mourning Dove",
    "Eurasian Collared-dove","Common Starling","Cooper’s Hawk","Red-legged Seriema",
    "Black-billed Magpie","Black-capped Chickadee","Human","Song Sparrow",
    "Chicken","Cow","California Quail","Bullock’s Oriole","Chilean Flamingo",
    "Western Kingbird","Black-necked Grebe","Cliff Swallow","Dog","Emu",
    "European Quail","Japanese Quail","Flycatcher (sp.)","Hermit Thrush",
    "Marsh Wren","Pronghorn","Rock Dove / Feral Pigeon","Sandhill Crane",
    "Swainson’s Hawk","Toco Toucan","Western Meadowlark","Western Tanager",
    "Yellow Warbler"
  ),
  family = c(
    "Fringillidae","Passeridae","Turdidae","Columbidae","Columbidae","Sturnidae",
    "Accipitridae","Cariamidae","Corvidae","Paridae","Hominidae","Passerellidae",
    "Phasianidae","Bovidae","Odontophoridae","Icteridae","Phoenicopteridae",
    "Tyrannidae","Podicipedidae","Hirundinidae","Canidae","Dromaiidae",
    "Phasianidae","Phasianidae","Tyrannidae","Turdidae","Troglodytidae",
    "Antilocapridae","Columbidae","Gruidae","Accipitridae","Ramphastidae",
    "Icteridae","Cardinalidae","Parulidae"
  ),
  order = c(
    "Passeriformes","Passeriformes","Passeriformes","Columbiformes","Columbiformes","Passeriformes",
    "Accipitriformes","Cariamiformes","Passeriformes","Passeriformes","Primates","Passeriformes",
    "Galliformes","Artiodactyla","Galliformes","Passeriformes","Phoenicopteriformes",
    "Passeriformes","Podicipediformes","Passeriformes","Carnivora","Casuariiformes",
    "Galliformes","Galliformes","Passeriformes","Passeriformes","Passeriformes",
    "Artiodactyla","Columbiformes","Gruiformes","Accipitriformes","Piciformes",
...
# join this with a long-format version of your counts:
library(reshape2) # or tidyr::pivot_longer

# melt counts_matrix to long
counts_long <- melt(counts_matrix,
                    id.vars = c("year_month_loc","loc_positives"),
                    measure.vars = grep("^host_", names(counts_matrix), value = TRUE),
                    variable.name = "host_species",
                    value.name = "count")

# add taxonomy info
counts_annotated <- merge(counts_long, host_taxonomy, by = "host_species", all.x = TRUE)
