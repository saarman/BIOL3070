...
```{r stacked-plot,fig.align='left',fig.width=7,fig.height=7, warning=FALSE}
## 1) Identify host columns
host_cols <- grep("^host_", names(counts_matrix), value = TRUE)
...
But... we can't without more Cx. tarsalis bloodmeal data, because... Every bloodmeal observation in overlap is being “tagged” with the species from the pools at that site × year.
